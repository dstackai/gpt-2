...
parser.add_argument('--fail_after', metavar='N', type=int, default=0, help='Fail after N steps')
...
def main():
    ...
    with tf.Session() as sess:
        ...
        try:
            while True:
                if 0 < args.fail_after < counter:
                    exit(f"Failed due to counter > {args.fail_after}")
